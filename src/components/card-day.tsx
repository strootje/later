...
const dayCardVariants = cva(
  tw("inline-flex flex-col items-center rounded bg-white ring-1"),
  {
    variants: {
      isToday: {
        false: tw("shadow-stone-700 ring-stone-700"),
        true: tw("shadow-green-700 ring-green-700"),
      },
      selected: {
        false: null,
        true: tw("shadow-[1.5px_1.5px_0_1.5px] fw-500"),
      },
    },
  },
);
